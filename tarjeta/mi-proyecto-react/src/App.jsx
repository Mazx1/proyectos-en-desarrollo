...
function App() {
  ...
  const handleIniciar = () => {
    if (audioRef.current) {
      audioRef.current.play().catch((err) =>
        alert("Error audio: " + err.name + " - " + err.message)
      );
    }
    setIniciado(true);
  };
  ...
  return (
    <div className="app">
      ...
      {/* 👉 Contenido de la tarjeta: solo se muestra si SÍ se ha iniciado */}
      {iniciado && (
        <>
          {/* 🎥 VIDEO DE FONDO */}
